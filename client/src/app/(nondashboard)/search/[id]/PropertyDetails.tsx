      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {property.amenities.map((amenity: AmenityEnum) => {
            ...
            return (
              <div key={amenity} className="flex flex-col items-center rounded-xl border px-4 py-8">
        ...
        <Tabs defaultValue="required-fees" className="mt-8">
          ...
          <TabsContent value="required-fees" className="w-1/3">
            ...
            <div className="flex justify-between bg-secondary-50 py-2">
              <span className="font-medium text-primary-700">Application Fee</span>
              <span className="text-primary-700">${property.applicationFee}</span>
            </div>
            <hr />
            <div className="flex justify-between bg-secondary-50 py-2">
              <span className="font-medium text-primary-700">Security Deposit</span>
